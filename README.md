...
- Restricts application functionality based upon authentication - Navlinks cannot be accessed until you've logged in. This is restricted on the frontend.
